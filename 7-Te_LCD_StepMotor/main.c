...
void configura_PWM(void); // PB6 Ch1 TIM4
...
int main(void) {
	...
	xTaskCreate(task4, "Contrast", 300 , NULL, 1 , NULL);
...
void configura_PWM(void)
{
    ...
    TIM4->ARR = 20000; // 20000 ciclos na frequência de clock do timer

    TIM4->CCR1 = 1500; // Duty cycle inicial de 7,5% (1500 ciclos)
